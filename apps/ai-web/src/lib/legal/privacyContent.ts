  ...
  return [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Статистика использования: факт и время действия — анализ по фото, по тексту, по фото и тексту, уточнение результата, ручной ввод, сканирование штрихкода. Содержимое фото, текста описания и записей дневника в эту статистику не включается.',
        ...
        'Для AI-анализа: фото еды и текстовые описания передаются в AI Gateway на время обработки запроса (см. раздел 5); они не сохраняются как часть статистики использования.',
