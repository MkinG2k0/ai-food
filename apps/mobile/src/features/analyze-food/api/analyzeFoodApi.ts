...
itemCount > 1 только если видно несколько отдельно взятых одинаковых единиц, которые обычно считают поштучно как целые порции: 2 ролла суши, 2 бургера, 3 отдельных печенья без общего «блюда с соусом», 2 йогурта рядом.
