...
const LEGACY_NUTRITION_XML_SCHEMA = `<analysis>
  ...
  <itemCount>число распознанных единиц (кусков/штук) — например 2 ролла → 2; одно блюдо без штук → 1. НЕ равно числу items в составе</itemCount>
...
- itemCount — сколько отдельных съедобных единиц видно (куски/штуки): 2 ролла → 2, 3 печенья → 3, миска супа / одно блюдо на тарелке → 1. Это НЕ длина массива items.
- КБЖУ и grams считай на ВСЕ видимые единицы вместе (totals = сумма по всем штукам).
...
## Порция и граммы (обязательно)
- grams обязателен для каждого item (только число в граммах).
- itemCount — сколько отдельных съедобных единиц в описании (куски/штуки): «2 ролла» → 2, «3 печенья» → 3, одно блюдо без штук → 1. Это НЕ длина массива items.
- КБЖУ и grams — на все единицы вместе.
...
## Порция и граммы (обязательно)
- grams обязателен для каждого item.
- itemCount — сколько отдельных съедобных единиц в описании (куски/штуки): «2 ролла» → 2; одно блюдо без штук → 1. Это НЕ длина массива items.
- КБЖУ и grams — на все единицы вместе.
